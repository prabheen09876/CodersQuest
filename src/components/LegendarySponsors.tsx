...
const LegendarySponsors = () => {
  ...
  return (
    <section className="relative w-full py-10 sm:py-16 border-y-4 border-[#585858] overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10 flex flex-col items-center">
        <div className="inline-block bg-[#AA0000] border-2 border-[#550000] px-6 py-2 sm:px-10 sm:py-3 mb-8 sm:mb-12 transform -rotate-1 shadow-2xl">
          <h3 className="text-[#FFAA00] font-minecraft text-xl sm:text-3xl tracking-widest uppercase drop-shadow-md">
            Legendary Sponsors
          </h3>
        </div>

        <div className="flex flex-col md:flex-row items-center justify-center gap-10 sm:gap-20 w-full">
          {/* Title Sponsor - Beacon */}
          <div className="flex flex-col items-center group relative">
            <div className="relative w-40 h-40 sm:w-64 sm:h-64 flex items-center justify-center mb-4">
              {/* Beacon Beam Effect */}
              <div className="absolute bottom-0 w-40 h-[800px] bg-white/20 blur-2xl animate-pulse"
                style={{ transform: 'translateY(-50%)' }} />

              <div className="relative w-36 h-36 sm:w-56 sm:h-56 image-pixelated z-10 animate-float flex items-center justify-center"
            ...
            <div className="text-[#55FFFF] font-minecraft text-base sm:text-xl mt-2 tracking-wide">TITLE SPONSOR</div>
          ...
          <div className="flex flex-col items-center">
            <h4 className="text-[#AAAAAA] font-minecraft mb-6 sm:mb-8 text-base sm:text-xl">CO-TITLE SPONSORS</h4>
            <div className="grid grid-cols-2 gap-4 sm:gap-8">
              {sponsors.coTitle.map((name, i) => (
                <div key={i} className="group relative">
                  <div className="w-24 h-24 sm:w-32 sm:h-32 image-pixelated border-4 border-[#3C3D42] shadow-xl transition-transform hover:scale-105 flex items-center justify-center"
