...
const SponsorsPage: React.FC = () => {
    ...
    return (
      ...
      >
        ...
        {/* --- Main Content --- */}
        <div className="relative z-10 flex flex-col items-center pt-10 pb-20 w-full max-w-6xl mx-auto px-4">
          
            {/* Page Title */}
            <h1 className="text-4xl md:text-6xl font-bold mb-16 tracking-widest text-center"
                style={{ textShadow: '4px 4px 0 #000' }}>
                SPONSOR TIERS
            </h1>
  
            {/* --- Level 1: END CRYSTAL + TITLE SPONSOR --- */}
            <div className="relative mb-24 flex flex-col items-center animate-float">
                {/* Crystal Effect */}
